 ...
 * Date: 11/8/2024
 * Description: Creates Mandelbrot images in PPM format using four threads, with each thread managing a separate quadrant. Supports randomized coloring
 ---------------------------------------------*/
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
...
//function to compute mondelbrot image quadrants using input data
